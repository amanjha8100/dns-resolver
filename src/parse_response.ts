...
import { ParseResponse2 } from "./parse_response_2";
...
export class ParseResponse {
    ...
    public parseDomainName(domain: string): string {
        ...
        while(true) {
            ...
            // console.log("Ye dekhan ekbaar: ",domainanswer)
            domainanswer+="."
    ...
    public moveAheadFromTypesAndEverything(name: string, type: boolean): string {
        ...
        */
        ...
        name = name.substr(4);
        //removing address
        // console.log("Process address Name: ", name);
        if(!type) {
            name = name.substr(8);
        } else {
    ...
    public extractAnswerRecords(): string {
        ...
        while(true) {
            ...
            const octetDecimal = parseInt(octet, 16);
            // console.log("Pehla octet: ", octetDecimal)
        ...
        */
            ...
            for(let i=0;i<numberOfAnswerRecords;i++) {
                ...
                */
                ...
                if(pointer) {
                    ...
                    // let lengthofresolveddata = sendString.length;
                    // console.log("sendstring: ", sendString);
                    // console.log("Aman Jha: ", formedanswer)
                ...
                // console.log("Tanushri: ", name);
                if(type === "0005") {
                    const CNAME = this.getAuthorativeServer(name);
                    console.log();
                    console.log("AT CNAME:", CNAME);
        ...
        for(let i=0;i<authority;i++) {
            ...
            console.log();
            console.log("AT AUTHORATIVE SERVER: ", authorativeServerResponse)
            ...
            if(type == "0002") {
                ...
                // count+=1;
                const pR = new ParseResponse2();
                pR.DnsResponse = this.nameServerResponse;
                let answer = pR.extractAnswerRecords();
